...
<head>
  ...
  <title>Alpha Nerd | Create account</title>
...
<main class="center">
  <section class="auth" aria-label="Create account form">
    <h1>Create account</h1>
    <p>This page is UI only for now. Later we will connect real registration.</p>
    ...
    <form action="#" method="post">
      ...
      <input class="input" id="password2" type="password" placeholder="••••••••" />

      <div class="hint">
        By creating an account, you agree to keep discussions respectful.
      </div>

      <div style="height:14px;"></div>
      <button class="btn primary full" type="button">Create account</button>

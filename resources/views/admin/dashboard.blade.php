...
<div class="row">
  ...
  <div class="col-lg-3 col-6">
    <div class="small-box text-bg-warning">
      ...
      <a href="{{ route('admin.messages.index') }}" class="small-box-footer link-dark link-underline-opacity-0 link-underline-opacity-50-hover">
        More info <i class="bi bi-link-45deg"></i>
      </a>
    </div>
  </div>
  ...
  <div class="col-lg-3 col-6">
    <div class="small-box text-bg-danger">
      ...
      <a href="{{ route('admin.posts.deleted') }}" class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
        More info <i class="bi bi-link-45deg"></i>
      </a>
    </div>
  </div>
